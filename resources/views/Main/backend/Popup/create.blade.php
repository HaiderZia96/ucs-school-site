                        ...
                        <form action="{{route('popup.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control rounded-0 @error('title') is-invalid @enderror" name="title" onkeyup="listingslug(this.value)"  value="{{old('title')}}" placeholder="Enter Title">
                                    @error('title')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control rounded-0 @error('slug') is-invalid @enderror" name="slug" id="slug" value="{{old('slug')}}">
                                </div>
                                <!--Label For image-->
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control rounded-0 @error('position') is-invalid @enderror" name="position" value="{{old('position')}}" placeholder="Enter Position">
                                    @error('position')
                                    <div class="alert text-danger m-0 p-0">{{ $message }}</div>
                                    @enderror
                                </div>
