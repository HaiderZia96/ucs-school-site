    ...
    <div class="container-fluid">
        ...
        <div class="card rounded-0">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form method="POST" action="{{ route('prospectus.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <!--Label For Name-->
                                    <label class="form-label" for="name">Name</label>
                                    <input type="text" class="form-control rounded-0 @error('name') is-invalid @enderror" id="name" name="name" value="{{old('name')}}" onkeyup="listingslug(this.value)">
                                    @if ($errors->has('name'))
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control rounded-0 @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{old('slug')}}">
                                    @if ($errors->has('slug'))
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="sub_details" id="sub_details" rows="5" class="form-control rounded-0 mb-0 @error('sub_details') is-invalid @enderror">{{old('sub_details')}}</textarea>
